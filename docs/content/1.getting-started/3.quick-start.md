...
After [installing the package](/getting-started/installation), add the package to your `nuxt.config.ts`:
...
To learn how to protect pages read [about the application-side usage](/application-side), to learn how to protect server-routes and API endpoints read [about the server-side usage](/server-side).
