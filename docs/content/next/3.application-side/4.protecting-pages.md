...
4. Guest mode: Only logged out people can view the page, [more here](/nuxt-auth/next/application-side/guest-mode)
...
Now *all pages* will require sign-in. Learn how to add excepted pages [below](/nuxt-auth/next/application-side/protecting-pages#disabling-the-global-middleware-locally)
...
Since v0.5.0 `nuxt-auth` also offers a guest mode. Checkout the [guest mode](/nuxt-auth/next/application-side/guest-mode) documentation.
