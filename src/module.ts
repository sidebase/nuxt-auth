...
const authjsDefaults: DeepRequired<AuthProviders> = {
  type: 'authjs',
  trustHost: false,
...
export default defineNuxtModule<ModuleOptions>({
  ...
  setup(userOptions, nuxt) {
    ...
    addImports([
      {
        name: 'useAuth',
        from: resolve('./runtime/composables/authjs/useAuth'),
      },
      {
        name: 'useAuthState',
        from: resolve('./runtime/composables/authjs/useAuthState'),
      },
    ])
    ...
    addTypeTemplate({
      ...
      getContents: () =>
        [
          '// AUTO-GENERATED BY @zitadel/nuxt-auth',
          `import { RouteOptions, AuthMeta } from '${resolve('./runtime/types.ts')}'`,
